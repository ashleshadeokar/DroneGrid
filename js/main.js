...
(function(html) {
    ...
    * ------------------------------------------------------ */
    ...
    document.addEventListener('DOMContentLoaded', function() {
        ...
        document.querySelectorAll('.entry__link').forEach(item => {
            console.log('Setting up click event for:', item);
            item.addEventListener('click', function(e) {
                ...
                if (!videoURL) {
                    ...
                    return; // Exit if no video URL is found
                }
    
                let videoHtml = `<iframe width="560" height="315" src="${videoURL}?autoplay=1" frameborder="0" allow="autoplay; encrypted-media" allowfullscreen></iframe>`;
                let videoContainer = this.closest('.entry').querySelector('.entry__video');
                videoContainer.innerHTML = videoHtml; // Load video in the video div within the same 'entry'
                videoContainer.style.display = 'block'; // Show the video div
            });
        });
    });
    ...
    $(document).ready(function(){
        $('.venobox').venobox({
            bgcolor: 'rgba(0,0,0,0.5)', // Background color with transparency
            border: '0px', // No border
            spinner: 'cube-grid', // Spinner type
            spinColor: '#fff', // Spinner color
            titleattr: 'data-title', // Attribute to fetch the title from
            titlePosition: 'bottom', // Position of the title
            titleBackground: '#000', // Background color of the title
            titleColor: '#fff', // Color of the title text
            overlayClose: true, // Close on overlay click
            autoplay: true, // Autoplay videos
            infinigall: true // Allows infinite gallery navigation
        });
    });
